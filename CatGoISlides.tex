...
\begin{frame}
	...
	A methodical process for recovering a matrix factorisation proper which is homotopy equivalent to the composite is the contents of Murfet's paper \cite{cut_operation}. The relevant part of this process for today's purposes is the definition of the \textbf{cut} of two matrix factorisations.
	\begin{defn}
...
\begin{frame}
	...
	Earlier we used a sequent style presentation of multiplicative linear logic. For our models though we used proof nets.
